...
BOB_INLINE void listbase_split(ListBase *lb, ListBase *left, ListBase *right) {
...
BOB_INLINE void listbase_concat(ListBase *result, ListBase *left, ListBase *right, int (*cmp)(const void *, const void *, void *), void *user_data) {
	Link *tail = NULL;
...
BOB_STATIC void mergesort_listbase(ListBase *lb, int (*cmp)(const void *, const void *, void *), void *user_data) {
